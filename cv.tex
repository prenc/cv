...
\hypersetup{pdftitle={Pawel Renc — Scientific CV},pdfauthor={Pawel Renc}}
...
\fancyfoot[L]{\footnotesize\color{muted}Pawel Renc \enspace / \enspace Scientific CV}
...
Research fellow at Massachusetts General Hospital working on generative models of longitudinal electronic health records and the infrastructure for training and evaluating them. Co-developer of ETHOS, combining healthcare-AI research with industry experience at Snowflake and high-performance computing research at ETH Zürich.
\section{Education}
...
\role{Research Fellow}{May 2026–present}{Massachusetts General Hospital · \href{https://ipol.mgh.harvard.edu/}{iPOL}}{Boston, MA}
\begin{itemize}
...
\item Led software and formal analysis for adaptive risk estimation using ETHOS-generated patient timelines.
\end{itemize}
...
\end{itemize}
\newpage
{\large\bfseries Pawel Renc}\hfill{\small\color{muted}Publications, software \& service}
...
\textbf{\href{https://github.com/ipolharvard/ethos-ares}{ETHOS}} — EHR tokenization, transformer training and health-trajectory inference.
...
\textbf{Grand rounds:} Applications of Machine Learning in Healthcare, DHR Health, April 29, 2024.\\
